...
<article class="homepage-article grid-item">
    <section class="about">
...
<article class="homepage-article social grid-item">
...
<article class="article grid-item home-projects">
    ...
    <section class="home-projects-list">
        <? $projects = page('projecten')->children()->visible()->limit(4);
        foreach($projects as $project): ?>
            <a href="<?= $project->url() ?>" class="home-project-link">
                <img src="<?= $project->images()->sortBy('sort', 'asc')->first()->thumb(array('width' => 300))->url() ?>" alt="Thumbnail for <?= $project->title()->html() ?>" class="home-project-image" />
            </a>
        <? endforeach; ?>
    </section>
...
<article class="article grid-item home-contact">
    ...
    <section>
        <p class="home-contact-intro">
            Neem <a href="/contact/">contact</a> met ons op. Wij zijn hier te vinden:
        </p>
        <p class="home-contact-adres">
            DAVL Studio<br />
            Berkstraat 2<br />
            2565MS Den Haag<br />
