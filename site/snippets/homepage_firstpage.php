    ...
    <div class="homepage-article-content">
        ...
        <a href="//instagram.com/davlstudio">
            <figure class="homepage-article-image">
                <img src="/assets/build/img/instagram_coolhouse.jpg" alt="exterieurfoto van het Coolhouse in Scheveningen - Volg DAVL Studio op Instagram">
...
<article class="homepage-article social grid-item random-background">
    <div class="homepage-article-content">
        ...
        <a href="https://www.linkedin.com/company/2685474/" class="linkedin social-icon">
